<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ControlPositionBIG.ascx.vb" Inherits="WBWIP.ControlPositionBIG" %>
...
<asp:Panel ID="Panel1" runat="server" BorderStyle="Solid"  Font-Size="20pt" CssClass="body" > 
     
    <table style="width: 100%;height:250px" border="0">
        <tr>
            <td style="text-align:left" class="auto-style1">
                <asp:Label ID="lbLotNo" runat="server" Font-Size="19pt"></asp:Label>
            </td>
        ...
        <tr>
            <td colspan="4" style="text-align:left">
                <asp:Label ID="lbPKG" runat="server" Font-Size="19pt"></asp:Label>
            </td>
        </tr>
        <tr>
            <td  colspan="4" style="text-align:left">
                <asp:Label ID="lbDevice" runat="server" Font-Size="19pt"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="4" style="text-align:left">
                <asp:Label ID="lbWireType" runat="server" Font-Size="19pt"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="2" style="text-align:left">
                <asp:Label ID="lbFrameType" runat="server" Font-Size="19pt"></asp:Label>
            </td>
            <td colspan="2" style="text-align:right"><asp:Label ID="lbTime" runat="server" Font-Size="19pt"></asp:Label></td>
        </tr>
        <tr>
            <td style="text-align:left">
                 <asp:Label ID="lbMCNoRequest" runat="server" Font-Size="19pt"></asp:Label>
            </td>
