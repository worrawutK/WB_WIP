<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WBWIP.aspx.vb" Inherits="WBWIP.DBWIP" %>

<%@ Register Src="~/ControlPosition.ascx" TagPrefix="uc1" TagName="ControlPosition" %>
                                        ...
                                        <asp:Panel ID="Panel1" runat="server" align="center">
                                            ...
                                            <table border="1" style="width:100%;height:750px;background-color: #ffffff;" >
                                                    ...
                                                    <td style="width:33%">
                                                     ...
                                                     <td >
                                                        <uc1:ControlPosition ID="ControlPosition02" runat="server" />
                                                         <%-- <uc1:ControlPositionBIG ID="ControlPositionBIG02" runat="server" />--%>
                                                    </td>
                                                   <td style="width:33%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <%--<uc1:ControlPositionBIG ID="ControlPositionBIG05" runat="server" />--%>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                          <%--<uc1:ControlPositionBIG ID="ControlPositionBIG08" runat="server" />--%>
                                        ...
                                        <asp:Button ID="SubmitButton" CssClass="hide" runat="server" Text="Input Lot No."  UseSubmitBehavior="False" Font-Bold="True" Font-Size="15pt" Height="33px" Width="100%"  /><%--OnClick="SubmitButton_Click"--%>
                                            ...
                                            <tr >
                                                <td style="text-align:right;" class="auto-style3">
                                                    ...
                                                    <asp:Label Font-Names="Andalus" ID="Label2" runat="server" Font-Size="20px" ForeColor="White">OP No. :</asp:Label>
                                                </td>
                                                ...
                                                <td class="auto-style3" style="text-align:right;">
                                                    <asp:Label Font-Names="Andalus" ID="Label3" runat="server" Font-Size="20px" ForeColor="White">Lot No. :</asp:Label>
                                                </td>
                                                <td class="auto-style3" style="text-align:left;">
                                                    <asp:TextBox ID="tbLotNo" runat="server"></asp:TextBox>
                                                </td>
                                                <td class="auto-style3" style="text-align:right;">
                                                    <asp:Label Font-Names="Andalus" ID="Label4" runat="server" Font-Size="20px" ForeColor="White">RackNo :</asp:Label>
                                                </td>
                                                <td class="auto-style3" style="text-align:left;">
                                                ...
                                                <td class="auto-style3" style="text-align:left;">
                                                    ...
                                                    <asp:Button class="buttonOrange" Height="25px" ID="Button4" Font-Names="Andalus" runat="server" Text="Clear" style="vertical-align:top" />
                                                   
                                                    <asp:Button class="buttonOrange" Height="25px" ID="CacheRemove" Font-Names="Andalus" runat="server" Text="Cache Remove" style="vertical-align:top" />
